export default function MobileBar() {
  return (
    <div className="mobile-bar" role="navigation" aria-label="Hızlı iletişim">
      <a
        href="tel:+905403363873"
        className="flex-1 flex items-center justify-center gap-2 py-4 bg-[#404e5e] text-white font-bold text-sm active:bg-[#2d3844] transition-colors"
      >
      ...
      <a
        ...
        className="flex-1 flex items-center justify-center gap-2 py-4 bg-[#25d366] text-white font-bold text-sm active:bg-[#1eb857] transition-colors"
      >
